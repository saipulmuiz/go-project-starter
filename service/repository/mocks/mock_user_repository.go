...
// Source: github.com/saipulmuiz/go-project-starter/service (interfaces: UserRepository)
...
func (m *MockUserRepository) GetUserByID(arg0 context.Context, arg1 string) (models.User, serror.SError) {
	m.ctrl.T.Helper()
